...
contract("Dex", accounts => {
    ...
    describe("Should test the create limit order function", function() {
        ...
        it("Should pass if the BUY orderbook is in descending order", async () => {
            ...
            console.log("because iterating list backwards, will print in ascending order")
            for (let i = orderbook.length - 1; i > 0; i--) {
                assert(orderbook[i].price <= orderbook[i - 1].price, "Invalid price order")

                // because iterating list backwards, will print in ascending order
        ...
        it("Should pass if the SELL orderbook is in ascending order", async () => {
            ...
            console.log("because iterating list backwards, will print in descending order")
            for (let i = orderbook.length - 1; i > 0; i--) {
                assert(orderbook[i].price >= orderbook[i - 1].price, "Invalid price order")

                // because iterating list backwards, will print in descending order
                console.log(orderbook[i].price)                              
            }
            console.log(orderbook[0].price)
        });
    ...
    describe.only("Should test the create market order function", function() {
